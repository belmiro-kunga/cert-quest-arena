...
const PricingSection: React.FC = () => {
  return (
    <section className="py-16 bg-solarized-base02">
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          <h2 className="text-3xl font-bold mb-4 text-solarized-base3">Premium Access</h2>
          <p className="text-xl text-solarized-base1">Get unlimited access to all certification exams</p>
        </div>

        <div className="flex justify-center">
          <div className="w-full max-w-md p-8 bg-solarized-base03 rounded-lg shadow-cert-lg border border-solarized-base01">
            <div className="text-center">
              <h3 className="text-2xl font-bold mb-2 text-solarized-base3">Premium</h3>
              <p className="text-solarized-base0 mb-6">Full access to all premium features</p>
              <div className="text-4xl font-bold mb-6 text-solarized-blue">
                $49.99
            ...
            <ul className="space-y-4 mb-8">
              <li className="flex items-center">
                <Check className="h-5 w-5 text-solarized-green mr-2" />
            ...
            <Button className="w-full bg-solarized-blue hover:bg-solarized-blue/90 text-solarized-base3">
              Get Premium
            </Button>
          </div>
        </div>
        ...
        <div className="mt-12 text-center">
          <p className="text-solarized-base0">
            Premium exams starting at <span className="font-bold text-solarized-base3">$19.99</span>
          </p>
